 ...
 * This class will be static as to avoid creating memory leaks and management errors.
 * TODO MORE INFO
...
//----------------------------------------------------------------------------
    ...
    static ArrayList<String> args;//The list of OSC arguments
...
//-----------------------------------------------------------------------------
    ...
    public static void start(){
        if (running)
            return;//Breaks off as to not create errors
        try{
            running = true;
